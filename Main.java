...
class Main{
    public static void main(String[] args) {
        ...
        if (input.contains("/")){
            ...
            if (input.contains("+")){System.out.println(math2.getPlus());}
            else if (input.contains("-")) {System.out.println(math2.getMinus());}
            else if (input.contains("*")) {System.out.println(math2.getUmn());}
        }
    }
}
